...
function App() {
  const [inputText, setInputText] = useState(
    'print("Shadow Code - Compile Python Code")'
  );
    ...
    <>
      ...
      <form onSubmit={handleSubmit} className="" method="post">
        ...
        {buttonClicked ? (
          ...
          <button
            className="bg-red-600 py-2 px-4 rounded text-white mt-2 flex flex-row mr-6 ml-auto justify-center items-center gap-2"
            type="submit"
          >
          ...
          <div className="flex flex-row justify-evenly gap-4 ">
            <h3 className="w-1/2 text-center flex flex-col gap-1 justify-center items-center bg-gray-800 rounded text-white h-32 text-xl">
              ...
              <h1 className="text-3xl text-green-400">
                {cpuTime} <span className="text-3xl text-green-400">%</span>
              </h1>{" "}
            </h3>
            <h3 className="w-1/2 text-center flex flex-col gap-1 justify-center items-center bg-gray-800 rounded text-white h-32 text-xl">
              {" "}
              ...
              <h1 className="text-3xl text-green-400">
                {memory} <span className="text-3xl text-green-400">KB</span>
              </h1>{" "}
            </h3>
          </div>
        </div>
